...
1. **Read all mentioned files immediately and FULLY**:
   - Research documents: @research_plan.md
...
2. **Spawn initial research tasks to gather context**:
   ...
   - Use the **spec-reviewer** agent to extract key technical requirements of the application
...
3. **Spawn parallel sub-tasks for comprehensive research**:
   ...
   **For deeper investigation:**
   ...
   - **@spec-reviewer** - To ensure the plan aligns with technical specifications and requirements.
